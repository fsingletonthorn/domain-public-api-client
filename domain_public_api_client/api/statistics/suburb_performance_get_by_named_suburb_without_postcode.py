...
from ...models.suburb_performance_get_by_named_suburb_without_postcode_period_size import (
    SuburbPerformanceGetByNamedSuburbWithoutPostcodePeriodSize,
)
from ...models.suburb_performance_get_by_named_suburb_without_postcode_property_category import (
...
def _get_kwargs(
    ...
    *,
    property_category: Union[
        Unset, SuburbPerformanceGetByNamedSuburbWithoutPostcodePropertyCategory
    ] = SuburbPerformanceGetByNamedSuburbWithoutPostcodePropertyCategory.HOUSE,
    bedrooms: Union[Unset, int] = UNSET,
    period_size: Union[
        Unset, SuburbPerformanceGetByNamedSuburbWithoutPostcodePeriodSize
    ] = SuburbPerformanceGetByNamedSuburbWithoutPostcodePeriodSize.QUARTERS,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/v2/suburbPerformanceStatistics/{state}/{suburb}",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        state (str):
        suburb (str):
        property_category (Union[Unset,
            SuburbPerformanceGetByNamedSuburbWithoutPostcodePropertyCategory]):  Default:
            SuburbPerformanceGetByNamedSuburbWithoutPostcodePropertyCategory.HOUSE.
        bedrooms (Union[Unset, int]):
        period_size (Union[Unset, SuburbPerformanceGetByNamedSuburbWithoutPostcodePeriodSize]):
            Default: SuburbPerformanceGetByNamedSuburbWithoutPostcodePeriodSize.QUARTERS.

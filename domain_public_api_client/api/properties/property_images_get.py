...
from ...models.property_enrichment_v2_image_results import PropertyEnrichmentV2ImageResults
from ...models.property_enrichment_v2_multiple_property_results import PropertyEnrichmentV2MultiplePropertyResults
from ...models.property_images_get_state import PropertyImagesGetState
...
def _get_kwargs(
    *,
    ...
    state: Union[Unset, PropertyImagesGetState] = UNSET,
) -> Dict[str, Any]:
    params: Dict[str, Any] = {}
...
) -> Optional[Union[Any, PropertyEnrichmentV2ImageResults, PropertyEnrichmentV2MultiplePropertyResults]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = PropertyEnrichmentV2ImageResults.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, PropertyEnrichmentV2ImageResults, PropertyEnrichmentV2MultiplePropertyResults]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Property images
     ...
     Search for a specific property and provide property images from latest sale/rental activity if
    ...
    Args:
        ...
        state (Union[Unset, PropertyImagesGetState]):
...
def sync(
    *,
    ...
    Returns:
        Union[Any, PropertyEnrichmentV2ImageResults, PropertyEnrichmentV2MultiplePropertyResults]
    """

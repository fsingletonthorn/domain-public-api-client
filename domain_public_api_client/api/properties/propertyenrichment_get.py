...
from ...models.property_enrichment_v2_property_results_v2 import PropertyEnrichmentV2PropertyResultsV2
from ...models.propertyenrichment_get_state import PropertyenrichmentGetState
...
def _get_kwargs(
    *,
    ...
    state: Union[Unset, PropertyenrichmentGetState] = UNSET,
) -> Dict[str, Any]:
    params: Dict[str, Any] = {}
...
) -> Optional[Union[Any, PropertyEnrichmentV2MultiplePropertyResults, PropertyEnrichmentV2PropertyResultsV2]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = PropertyEnrichmentV2PropertyResultsV2.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, PropertyEnrichmentV2MultiplePropertyResults, PropertyEnrichmentV2PropertyResultsV2]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """API that supplies property level data and activities across two packages for a specific property
     ...
     Search for a specific property and provide property information and latest sale/rental activity if
    found. Supply either propertyId, gnafId, or all address fields (with flatNumber optional)
    ...
    Args:
        ...
        state (Union[Unset, PropertyenrichmentGetState]):
...
def sync(
    *,
    ...
    Returns:
        Union[Any, PropertyEnrichmentV2MultiplePropertyResults, PropertyEnrichmentV2PropertyResultsV2]
    """

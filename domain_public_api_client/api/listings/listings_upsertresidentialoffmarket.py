...
from ...models.listing_admin_v2_residential_off_market_listing import ListingAdminV2ResidentialOffMarketListing
...
def _get_kwargs(
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "post",
        "url": "/v2/listings/residential/offmarket",
    }

    if isinstance(body, ListingAdminV2ResidentialOffMarketListing):
...
def sync_detailed(
    *,
    ...
    """Creates an externally sold or leased residential listing; or takes an existing residential listing
    off the market.

    Args:
        body (ListingAdminV2ResidentialOffMarketListing): Residential off market listing
        body (ListingAdminV2ResidentialOffMarketListing): Residential off market listing

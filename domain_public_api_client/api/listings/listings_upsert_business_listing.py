...
from ...models.domain_listing_admin_service_v1_model_business_listing import (
...
def _get_kwargs(
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "put",
        "url": "/v1/listings/business",
    }

    if isinstance(body, DomainListingAdminServiceV1ModelBusinessListing):
...
def sync_detailed(
    *,
    ...
    Args:
        body (DomainListingAdminServiceV1ModelBusinessListing): Business Listing
        body (DomainListingAdminServiceV1ModelBusinessListing): Business Listing

...
from ...models.listing_admin_v2_business_off_market_listing import ListingAdminV2BusinessOffMarketListing
...
def _get_kwargs(
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "post",
        "url": "/v2/listings/business/offmarket",
    }

    if isinstance(body, ListingAdminV2BusinessOffMarketListing):
...
def sync_detailed(
    *,
    ...
    Args:
        body (ListingAdminV2BusinessOffMarketListing): Business off market listing
        body (ListingAdminV2BusinessOffMarketListing): Business off market listing

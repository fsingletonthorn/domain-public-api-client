...
T = TypeVar("T", bound="DomainPublicAdapterWebApiModelsV1ListingsCommercialMedia")


@_attrs_define
class DomainPublicAdapterWebApiModelsV1ListingsCommercialMedia:
    r"""Listing media
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        domain_public_adapter_web_api_models_v1_listings_commercial_media = cls(
        ...
        domain_public_adapter_web_api_models_v1_listings_commercial_media.additional_properties = d
        return domain_public_adapter_web_api_models_v1_listings_commercial_media

...
from ..models.listings_v2_sold_details_sold_action import ListingsV2SoldDetailsSoldAction
from ..models.listings_v2_sold_details_source import ListingsV2SoldDetailsSource
from ..types import UNSET, Unset

T = TypeVar("T", bound="ListingsV2SoldDetails")


@_attrs_define
class ListingsV2SoldDetails:
    """Sold details in the case of the listing being sold.

    Attributes:
        sold_action (Union[Unset, ListingsV2SoldDetailsSoldAction]): Gets or Sets SoldAction
        source (Union[Unset, ListingsV2SoldDetailsSource]): Gets or Sets Source
    ...
    sold_action: Union[Unset, ListingsV2SoldDetailsSoldAction] = UNSET
    source: Union[Unset, ListingsV2SoldDetailsSource] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        sold_action: Union[Unset, ListingsV2SoldDetailsSoldAction]
        if isinstance(_sold_action, Unset):
            sold_action = UNSET
        else:
            sold_action = ListingsV2SoldDetailsSoldAction(_sold_action)

        _source = d.pop("source", UNSET)
        source: Union[Unset, ListingsV2SoldDetailsSource]
        if isinstance(_source, Unset):
            source = UNSET
        else:
            source = ListingsV2SoldDetailsSource(_source)
        ...
        return listings_v2_sold_details

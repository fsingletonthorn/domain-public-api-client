...
from ..models.listing_admin_v2_commercial_off_market_listing_listing_action import (
    ListingAdminV2CommercialOffMarketListingListingAction,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.listing_admin_v2_commercial_off_market_property import ListingAdminV2CommercialOffMarketProperty
...
T = TypeVar("T", bound="ListingAdminV2CommercialOffMarketListing")


@_attrs_define
class ListingAdminV2CommercialOffMarketListing:
    ...
    Attributes:
        ...
        listing_action (ListingAdminV2CommercialOffMarketListingListingAction): Sale or Rent
        off_market_details (ListingAdminV2OffMarketDetailsBase): Off market details base
        property_details (ListingAdminV2CommercialOffMarketProperty): Commercial off market property
    ...
    provider_ad_id: str
    listing_action: ListingAdminV2CommercialOffMarketListingListingAction
    off_market_details: "ListingAdminV2OffMarketDetailsBase"
    property_details: "ListingAdminV2CommercialOffMarketProperty"
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        listing_action = ListingAdminV2CommercialOffMarketListingListingAction(d.pop("listingAction"))

        off_market_details = ListingAdminV2OffMarketDetailsBase.from_dict(d.pop("offMarketDetails"))

        property_details = ListingAdminV2CommercialOffMarketProperty.from_dict(d.pop("propertyDetails"))
        ...
        listing_admin_v2_commercial_off_market_listing = cls(
        ...
        listing_admin_v2_commercial_off_market_listing.additional_properties = d
        return listing_admin_v2_commercial_off_market_listing

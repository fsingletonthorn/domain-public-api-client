...
T = TypeVar("T", bound="AuthoritiesV1CompanyResponse")


@_attrs_define
class AuthoritiesV1CompanyResponse:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        authorities_v1_company_response = cls(
            address=address,
            email=email,
            id=id,
            name=name,
        ...
        authorities_v1_company_response.additional_properties = d
        return authorities_v1_company_response

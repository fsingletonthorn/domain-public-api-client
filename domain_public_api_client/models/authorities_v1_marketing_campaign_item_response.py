...
T = TypeVar("T", bound="AuthoritiesV1MarketingCampaignItemResponse")


@_attrs_define
class AuthoritiesV1MarketingCampaignItemResponse:
    """
    Attributes:
        id (str):  Example: 0557934b-b9f8-4d88-bd5a-9c69d5bf0beb.
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        authorities_v1_marketing_campaign_item_response = cls(
            id=id,
            item_id=item_id,
        ...
        authorities_v1_marketing_campaign_item_response.additional_properties = d
        return authorities_v1_marketing_campaign_item_response

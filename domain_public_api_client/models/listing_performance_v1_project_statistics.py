...
T = TypeVar("T", bound="ListingPerformanceV1ProjectStatistics")


@_attrs_define
class ListingPerformanceV1ProjectStatistics:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        listing_performance_v1_project_statistics = cls(
        ...
        return listing_performance_v1_project_statistics

...
from ..models.listings_v1_median_price_data_price_type import ListingsV1MedianPriceDataPriceType
from ..types import UNSET, Unset

T = TypeVar("T", bound="ListingsV1MedianPriceData")


@_attrs_define
class ListingsV1MedianPriceData:
    """Information regarding median house/unit price   for the suburb

    Attributes:
        price_type (Union[Unset, ListingsV1MedianPriceDataPriceType]): Gets or Sets PriceType
    ...
    price_type: Union[Unset, ListingsV1MedianPriceDataPriceType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        price_type: Union[Unset, ListingsV1MedianPriceDataPriceType]
        if isinstance(_price_type, Unset):
            price_type = UNSET
        else:
            price_type = ListingsV1MedianPriceDataPriceType(_price_type)
        ...
        listings_v1_median_price_data = cls(
        ...
        return listings_v1_median_price_data

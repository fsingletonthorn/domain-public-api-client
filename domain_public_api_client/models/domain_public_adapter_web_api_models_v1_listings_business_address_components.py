...
T = TypeVar("T", bound="DomainPublicAdapterWebApiModelsV1ListingsBusinessAddressComponents")


@_attrs_define
class DomainPublicAdapterWebApiModelsV1ListingsBusinessAddressComponents:
    """Address components
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        domain_public_adapter_web_api_models_v1_listings_business_address_components = cls(
            area=area,
            district=district,
            postcode=postcode,
            region=region,
        ...
        domain_public_adapter_web_api_models_v1_listings_business_address_components.additional_properties = d
        return domain_public_adapter_web_api_models_v1_listings_business_address_components

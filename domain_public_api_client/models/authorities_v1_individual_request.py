...
T = TypeVar("T", bound="AuthoritiesV1IndividualRequest")


@_attrs_define
class AuthoritiesV1IndividualRequest:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        authorities_v1_individual_request = cls(
            address=address,
            email=email,
        ...
        authorities_v1_individual_request.additional_properties = d
        return authorities_v1_individual_request

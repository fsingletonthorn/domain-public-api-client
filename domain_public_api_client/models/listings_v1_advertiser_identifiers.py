...
from ..models.listings_v1_advertiser_identifiers_advertiser_type import ListingsV1AdvertiserIdentifiersAdvertiserType
from ..types import UNSET, Unset

T = TypeVar("T", bound="ListingsV1AdvertiserIdentifiers")


@_attrs_define
class ListingsV1AdvertiserIdentifiers:
    """Encapsulates the listing's advertiser identifiers

    Attributes:
        advertiser_type (Union[Unset, ListingsV1AdvertiserIdentifiersAdvertiserType]): Gets or Sets AdvertiserType
    ...
    advertiser_type: Union[Unset, ListingsV1AdvertiserIdentifiersAdvertiserType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        advertiser_type: Union[Unset, ListingsV1AdvertiserIdentifiersAdvertiserType]
        if isinstance(_advertiser_type, Unset):
            advertiser_type = UNSET
        else:
            advertiser_type = ListingsV1AdvertiserIdentifiersAdvertiserType(_advertiser_type)
        ...
        listings_v1_advertiser_identifiers = cls(
        ...
        return listings_v1_advertiser_identifiers

...
if TYPE_CHECKING:
    from ..models.domain_public_adapter_web_api_models_v1_listings_business_phone_number import (
        DomainPublicAdapterWebApiModelsV1ListingsBusinessPhoneNumber,
    )


T = TypeVar("T", bound="DomainPublicAdapterWebApiModelsV1ListingsBusinessContact")
...
class DomainPublicAdapterWebApiModelsV1ListingsBusinessContact:
    ...
    Attributes:
        ...
        phone_numbers (Union[Unset, List['DomainPublicAdapterWebApiModelsV1ListingsBusinessPhoneNumber']]): Phone
            numbers
    ...
    phone_numbers: Union[Unset, List["DomainPublicAdapterWebApiModelsV1ListingsBusinessPhoneNumber"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for phone_numbers_item_data in _phone_numbers or []:
            phone_numbers_item = DomainPublicAdapterWebApiModelsV1ListingsBusinessPhoneNumber.from_dict(
        ...
        domain_public_adapter_web_api_models_v1_listings_business_contact = cls(
            id=id,
        ...
        domain_public_adapter_web_api_models_v1_listings_business_contact.additional_properties = d
        return domain_public_adapter_web_api_models_v1_listings_business_contact

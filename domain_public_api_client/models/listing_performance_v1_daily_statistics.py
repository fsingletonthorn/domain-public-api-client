...
T = TypeVar("T", bound="ListingPerformanceV1DailyStatistics")


@_attrs_define
class ListingPerformanceV1DailyStatistics:
    """
    Attributes:
        ...
        event_date (Union[None, Unset, datetime.datetime]): Date of statistics events
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        listing_performance_v1_daily_statistics = cls(
        ...
        return listing_performance_v1_daily_statistics

...
if TYPE_CHECKING:
    from ..models.listings_v1_past_sale_data import ListingsV1PastSaleData


T = TypeVar("T", bound="ListingsV1ComparableData")


@_attrs_define
class ListingsV1ComparableData:
    """Information regarding the past comparable property sales that influenced the setting of the estimation price

    Attributes:
        comparable_property (Union[List['ListingsV1PastSaleData'], None, Unset]): Comparable properties that are of a
    ...
    comparable_property: Union[List["ListingsV1PastSaleData"], None, Unset] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_comparable_property(data: object) -> Union[List["ListingsV1PastSaleData"], None, Unset]:
            if data is None:
                return data
            ...
            try:
                ...
                for comparable_property_type_0_item_data in _comparable_property_type_0:
                    comparable_property_type_0_item = ListingsV1PastSaleData.from_dict(
                ...
                pass
            return cast(Union[List["ListingsV1PastSaleData"], None, Unset], data)
        ...
        listings_v1_comparable_data = cls(
            comparable_property=comparable_property,
            declaration_text=declaration_text,
        )

        return listings_v1_comparable_data

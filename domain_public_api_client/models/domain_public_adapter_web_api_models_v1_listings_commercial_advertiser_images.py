...
T = TypeVar("T", bound="DomainPublicAdapterWebApiModelsV1ListingsCommercialAdvertiserImages")


@_attrs_define
class DomainPublicAdapterWebApiModelsV1ListingsCommercialAdvertiserImages:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        domain_public_adapter_web_api_models_v1_listings_commercial_advertiser_images = cls(
            agency_banner_image_url=agency_banner_image_url,
            agency_banner_wide_image_url=agency_banner_wide_image_url,
            logo_url=logo_url,
        )

        domain_public_adapter_web_api_models_v1_listings_commercial_advertiser_images.additional_properties = d
        return domain_public_adapter_web_api_models_v1_listings_commercial_advertiser_images

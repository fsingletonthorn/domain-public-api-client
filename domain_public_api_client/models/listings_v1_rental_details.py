...
from ..models.listings_v1_rental_details_rental_method import ListingsV1RentalDetailsRentalMethod
from ..models.listings_v1_rental_details_source import ListingsV1RentalDetailsSource
from ..types import UNSET, Unset

T = TypeVar("T", bound="ListingsV1RentalDetails")


@_attrs_define
class ListingsV1RentalDetails:
    """The rental detail's of the listing in case of it being for rent or leased

    Attributes:
        rental_method (Union[Unset, ListingsV1RentalDetailsRentalMethod]): Gets or Sets RentalMethod
        source (Union[Unset, ListingsV1RentalDetailsSource]): Gets or Sets Source
    ...
    rental_method: Union[Unset, ListingsV1RentalDetailsRentalMethod] = UNSET
    source: Union[Unset, ListingsV1RentalDetailsSource] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rental_method: Union[Unset, ListingsV1RentalDetailsRentalMethod]
        if isinstance(_rental_method, Unset):
            rental_method = UNSET
        else:
            rental_method = ListingsV1RentalDetailsRentalMethod(_rental_method)

        _source = d.pop("source", UNSET)
        source: Union[Unset, ListingsV1RentalDetailsSource]
        if isinstance(_source, Unset):
            source = UNSET
        else:
            source = ListingsV1RentalDetailsSource(_source)
        ...
        listings_v1_rental_details = cls(
        ...
        return listings_v1_rental_details

...
T = TypeVar("T", bound="AuthoritiesV1AgentRequest")


@_attrs_define
class AuthoritiesV1AgentRequest:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        authorities_v1_agent_request = cls(
            name=name,
            email=email,
            id=id,
            user=user,
        ...
        authorities_v1_agent_request.additional_properties = d
        return authorities_v1_agent_request

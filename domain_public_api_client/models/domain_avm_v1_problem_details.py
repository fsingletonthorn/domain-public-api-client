...
T = TypeVar("T", bound="DomainAvmV1ProblemDetails")


@_attrs_define
class DomainAvmV1ProblemDetails:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        domain_avm_v1_problem_details = cls(
            type=type,
            title=title,
            status=status,
            detail=detail,
        ...
        domain_avm_v1_problem_details.additional_properties = d
        return domain_avm_v1_problem_details

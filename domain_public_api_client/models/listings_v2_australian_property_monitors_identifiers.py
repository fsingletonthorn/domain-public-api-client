...
T = TypeVar("T", bound="ListingsV2AustralianPropertyMonitorsIdentifiers")


@_attrs_define
class ListingsV2AustralianPropertyMonitorsIdentifiers:
    r"""APM Identifiers
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        listings_v2_australian_property_monitors_identifiers = cls(
        ...
        return listings_v2_australian_property_monitors_identifiers

...
from ..models.listings_v2_address_parts_display_type import ListingsV2AddressPartsDisplayType
from ..models.listings_v2_address_parts_state_abbreviation import ListingsV2AddressPartsStateAbbreviation
from ..types import UNSET, Unset

T = TypeVar("T", bound="ListingsV2AddressParts")


@_attrs_define
class ListingsV2AddressParts:
    """Encapsulates the parts that make up an Address

    Attributes:
        state_abbreviation (Union[Unset, ListingsV2AddressPartsStateAbbreviation]): Gets or Sets StateAbbreviation
        display_type (Union[Unset, ListingsV2AddressPartsDisplayType]): Gets or Sets DisplayType
    ...
    state_abbreviation: Union[Unset, ListingsV2AddressPartsStateAbbreviation] = UNSET
    display_type: Union[Unset, ListingsV2AddressPartsDisplayType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        state_abbreviation: Union[Unset, ListingsV2AddressPartsStateAbbreviation]
        if isinstance(_state_abbreviation, Unset):
            state_abbreviation = UNSET
        else:
            state_abbreviation = ListingsV2AddressPartsStateAbbreviation(_state_abbreviation)

        _display_type = d.pop("displayType", UNSET)
        display_type: Union[Unset, ListingsV2AddressPartsDisplayType]
        if isinstance(_display_type, Unset):
            display_type = UNSET
        else:
            display_type = ListingsV2AddressPartsDisplayType(_display_type)
        ...
        return listings_v2_address_parts

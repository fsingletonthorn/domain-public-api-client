...
T = TypeVar("T", bound="DomainAvmPIV1ProblemDetails")


@_attrs_define
class DomainAvmPIV1ProblemDetails:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        domain_avm_piv1_problem_details = cls(
            type=type,
            title=title,
            status=status,
            detail=detail,
        ...
        domain_avm_piv1_problem_details.additional_properties = d
        return domain_avm_piv1_problem_details

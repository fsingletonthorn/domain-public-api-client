...
T = TypeVar("T", bound="PreMarketV1ProblemDetails")


@_attrs_define
class PreMarketV1ProblemDetails:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        pre_market_v1_problem_details = cls(
            type=type,
            title=title,
            status=status,
            detail=detail,
        ...
        pre_market_v1_problem_details.additional_properties = d
        return pre_market_v1_problem_details

...
from ..models.listings_v2_inspection_recurrence import ListingsV2InspectionRecurrence
from ..types import UNSET, Unset

T = TypeVar("T", bound="ListingsV2Inspection")


@_attrs_define
class ListingsV2Inspection:
    """Encapsulates the details of a Listing's Inspection

    Attributes:
        recurrence (Union[Unset, ListingsV2InspectionRecurrence]): Gets or Sets Recurrence
    ...
    recurrence: Union[Unset, ListingsV2InspectionRecurrence] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        recurrence: Union[Unset, ListingsV2InspectionRecurrence]
        if isinstance(_recurrence, Unset):
            recurrence = UNSET
        else:
            recurrence = ListingsV2InspectionRecurrence(_recurrence)

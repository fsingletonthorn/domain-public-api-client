...
T = TypeVar("T", bound="ListingPerformanceV1ProjectListingStatistics")


@_attrs_define
class ListingPerformanceV1ProjectListingStatistics:
    """
    Attributes:
        ...
        total_shortlisted (Union[None, Unset, int]): Total number of times the listing was short listed
        total_statement_of_information_downloads (Union[None, Unset, int]): Total number of times when statement of
            information download
        total_statement_of_information_reveals (Union[None, Unset, int]): Total number of times when statement of
            information reveals
        total_added_notes (Union[None, Unset, int]): Total number of times when notes added
        total_completed_inspection_checklist (Union[None, Unset, int]): Total number of completed inspection checklist
        total_virtual_tour_views (Union[None, Unset, int]): Total number of views from virtual tours
        listing_id (Union[Unset, int]):
    """
    ...
    total_statement_of_information_downloads: Union[None, Unset, int] = UNSET
    total_statement_of_information_reveals: Union[None, Unset, int] = UNSET
    total_added_notes: Union[None, Unset, int] = UNSET
    total_completed_inspection_checklist: Union[None, Unset, int] = UNSET
    total_virtual_tour_views: Union[None, Unset, int] = UNSET
    listing_id: Union[Unset, int] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        total_statement_of_information_downloads: Union[None, Unset, int]
        if isinstance(self.total_statement_of_information_downloads, Unset):
            total_statement_of_information_downloads = UNSET
        else:
            total_statement_of_information_downloads = self.total_statement_of_information_downloads

        total_statement_of_information_reveals: Union[None, Unset, int]
        if isinstance(self.total_statement_of_information_reveals, Unset):
            total_statement_of_information_reveals = UNSET
        else:
            total_statement_of_information_reveals = self.total_statement_of_information_reveals

        total_added_notes: Union[None, Unset, int]
        if isinstance(self.total_added_notes, Unset):
            total_added_notes = UNSET
        else:
            total_added_notes = self.total_added_notes

        total_completed_inspection_checklist: Union[None, Unset, int]
        if isinstance(self.total_completed_inspection_checklist, Unset):
            total_completed_inspection_checklist = UNSET
        else:
            total_completed_inspection_checklist = self.total_completed_inspection_checklist

        total_virtual_tour_views: Union[None, Unset, int]
        if isinstance(self.total_virtual_tour_views, Unset):
            total_virtual_tour_views = UNSET
        else:
            total_virtual_tour_views = self.total_virtual_tour_views
        ...
        if total_statement_of_information_downloads is not UNSET:
            field_dict["totalStatementOfInformationDownloads"] = total_statement_of_information_downloads
        if total_statement_of_information_reveals is not UNSET:
            field_dict["totalStatementOfInformationReveals"] = total_statement_of_information_reveals
        if total_added_notes is not UNSET:
            field_dict["totalAddedNotes"] = total_added_notes
        if total_completed_inspection_checklist is not UNSET:
            field_dict["totalCompletedInspectionChecklist"] = total_completed_inspection_checklist
        if total_virtual_tour_views is not UNSET:
            field_dict["totalVirtualTourViews"] = total_virtual_tour_views
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_total_statement_of_information_downloads(data: object) -> Union[None, Unset, int]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        total_statement_of_information_downloads = _parse_total_statement_of_information_downloads(
            d.pop("totalStatementOfInformationDownloads", UNSET)
        )

        def _parse_total_statement_of_information_reveals(data: object) -> Union[None, Unset, int]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        total_statement_of_information_reveals = _parse_total_statement_of_information_reveals(
            d.pop("totalStatementOfInformationReveals", UNSET)
        )

        def _parse_total_added_notes(data: object) -> Union[None, Unset, int]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        total_added_notes = _parse_total_added_notes(d.pop("totalAddedNotes", UNSET))

        def _parse_total_completed_inspection_checklist(data: object) -> Union[None, Unset, int]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        total_completed_inspection_checklist = _parse_total_completed_inspection_checklist(
            d.pop("totalCompletedInspectionChecklist", UNSET)
        )

        def _parse_total_virtual_tour_views(data: object) -> Union[None, Unset, int]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        total_virtual_tour_views = _parse_total_virtual_tour_views(d.pop("totalVirtualTourViews", UNSET))

        listing_id = d.pop("listingId", UNSET)

        listing_performance_v1_project_listing_statistics = cls(
            ...
            total_statement_of_information_downloads=total_statement_of_information_downloads,
            total_statement_of_information_reveals=total_statement_of_information_reveals,
            total_added_notes=total_added_notes,
            total_completed_inspection_checklist=total_completed_inspection_checklist,
            total_virtual_tour_views=total_virtual_tour_views,
            listing_id=listing_id,
        )

        return listing_performance_v1_project_listing_statistics

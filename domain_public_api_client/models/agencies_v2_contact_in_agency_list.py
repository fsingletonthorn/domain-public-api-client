...
T = TypeVar("T", bound="AgenciesV2ContactInAgencyList")


@_attrs_define
class AgenciesV2ContactInAgencyList:
    """ContactInAgencyList
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        agencies_v2_contact_in_agency_list = cls(
            agency_id=agency_id,
            id=id,
            email=email,
        ...
        return agencies_v2_contact_in_agency_list

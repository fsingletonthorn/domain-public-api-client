...
if TYPE_CHECKING:
    from ..models.listings_v1_auction_schedule import ListingsV1AuctionSchedule


T = TypeVar("T", bound="ListingsV1AuctionDetails")


@_attrs_define
class ListingsV1AuctionDetails:
    """The detail's of the auction in case of a listing for sale being auctioned or sold by auction

    Attributes:
        auction_schedule (Union[Unset, ListingsV1AuctionSchedule]): Encapsulates the details of a Property being
            Auctioned.
    ...
    auction_schedule: Union[Unset, "ListingsV1AuctionSchedule"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        auction_schedule: Union[Unset, ListingsV1AuctionSchedule]
        if isinstance(_auction_schedule, Unset):
            auction_schedule = UNSET
        else:
            auction_schedule = ListingsV1AuctionSchedule.from_dict(_auction_schedule)

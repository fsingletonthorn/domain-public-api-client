...
T = TypeVar("T", bound="DomainListingAdminServiceV1ModelBasicPrice")


@_attrs_define
class DomainListingAdminServiceV1ModelBasicPrice:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        domain_listing_admin_service_v1_model_basic_price = cls(
            from_=from_,
            to=to,
        )

        domain_listing_admin_service_v1_model_basic_price.additional_properties = d
        return domain_listing_admin_service_v1_model_basic_price

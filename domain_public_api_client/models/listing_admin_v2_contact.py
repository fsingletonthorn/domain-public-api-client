...
T = TypeVar("T", bound="ListingAdminV2Contact")


@_attrs_define
class ListingAdminV2Contact:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        listing_admin_v2_contact.additional_properties = d
        return listing_admin_v2_contact

...
from ..models.listings_v2_price_details_gst_option import ListingsV2PriceDetailsGstOption
from ..models.listings_v2_price_details_hidden_reasons_type_0_item import ListingsV2PriceDetailsHiddenReasonsType0Item
from ..models.listings_v2_price_details_price_type import ListingsV2PriceDetailsPriceType
from ..models.listings_v2_price_details_price_unit import ListingsV2PriceDetailsPriceUnit
from ..types import UNSET, Unset

T = TypeVar("T", bound="ListingsV2PriceDetails")


@_attrs_define
class ListingsV2PriceDetails:
    """Encapsulates a listing's price information

    Attributes:
        gst_option (Union[Unset, ListingsV2PriceDetailsGstOption]): Gets or Sets GstOption
        price_type (Union[Unset, ListingsV2PriceDetailsPriceType]): Gets or Sets PriceType
        price_unit (Union[Unset, ListingsV2PriceDetailsPriceUnit]): Gets or Sets PriceUnit
        ...
        can_display_price (Union[None, Unset, bool]): Flag indicating whether the advertiser has chosen to display the
            property price
        hidden_reasons (Union[List[ListingsV2PriceDetailsHiddenReasonsType0Item], None, Unset]): Reasons when price need
            to be hidden
    ...
    gst_option: Union[Unset, ListingsV2PriceDetailsGstOption] = UNSET
    price_type: Union[Unset, ListingsV2PriceDetailsPriceType] = UNSET
    price_unit: Union[Unset, ListingsV2PriceDetailsPriceUnit] = UNSET
    ...
    hidden_reasons: Union[List[ListingsV2PriceDetailsHiddenReasonsType0Item], None, Unset] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        gst_option: Union[Unset, ListingsV2PriceDetailsGstOption]
        if isinstance(_gst_option, Unset):
            gst_option = UNSET
        else:
            gst_option = ListingsV2PriceDetailsGstOption(_gst_option)

        _price_type = d.pop("priceType", UNSET)
        price_type: Union[Unset, ListingsV2PriceDetailsPriceType]
        if isinstance(_price_type, Unset):
            price_type = UNSET
        else:
            price_type = ListingsV2PriceDetailsPriceType(_price_type)

        _price_unit = d.pop("priceUnit", UNSET)
        price_unit: Union[Unset, ListingsV2PriceDetailsPriceUnit]
        if isinstance(_price_unit, Unset):
            price_unit = UNSET
        else:
            price_unit = ListingsV2PriceDetailsPriceUnit(_price_unit)
        ...
        def _parse_hidden_reasons(
            data: object,
        ) -> Union[List[ListingsV2PriceDetailsHiddenReasonsType0Item], None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for hidden_reasons_type_0_item_data in _hidden_reasons_type_0:
                    hidden_reasons_type_0_item = ListingsV2PriceDetailsHiddenReasonsType0Item(
                ...
                pass
            return cast(Union[List[ListingsV2PriceDetailsHiddenReasonsType0Item], None, Unset], data)
        ...
        return listings_v2_price_details

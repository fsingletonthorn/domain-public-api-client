...
if TYPE_CHECKING:
    from ..models.listings_v2_basic_price import ListingsV2BasicPrice
    from ..models.listings_v2_comparable_data import ListingsV2ComparableData
    from ..models.listings_v2_median_price_data import ListingsV2MedianPriceData


T = TypeVar("T", bound="ListingsV2StatementOfInformation")


@_attrs_define
class ListingsV2StatementOfInformation:
    """Statement of Information  Regarding sale listing

    Attributes:
        estimated_price (Union[Unset, ListingsV2BasicPrice]): Basic price information
        comparable_data (Union[Unset, ListingsV2ComparableData]): Information regarding the past comparable property
            sales that influenced the setting of the estimation price
        suburb_median_price (Union[Unset, ListingsV2MedianPriceData]): Information regarding median house/unit price
            for the suburb
        documentation_url (Union[None, Unset, str]): Link to the statement of information documentation file
    """

    estimated_price: Union[Unset, "ListingsV2BasicPrice"] = UNSET
    comparable_data: Union[Unset, "ListingsV2ComparableData"] = UNSET
    suburb_median_price: Union[Unset, "ListingsV2MedianPriceData"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        estimated_price: Union[Unset, ListingsV2BasicPrice]
        if isinstance(_estimated_price, Unset):
            estimated_price = UNSET
        else:
            estimated_price = ListingsV2BasicPrice.from_dict(_estimated_price)

        _comparable_data = d.pop("comparableData", UNSET)
        comparable_data: Union[Unset, ListingsV2ComparableData]
        if isinstance(_comparable_data, Unset):
            comparable_data = UNSET
        else:
            comparable_data = ListingsV2ComparableData.from_dict(_comparable_data)

        _suburb_median_price = d.pop("suburbMedianPrice", UNSET)
        suburb_median_price: Union[Unset, ListingsV2MedianPriceData]
        if isinstance(_suburb_median_price, Unset):
            suburb_median_price = UNSET
        else:
            suburb_median_price = ListingsV2MedianPriceData.from_dict(_suburb_median_price)
        ...
        listings_v2_statement_of_information = cls(
        ...
        return listings_v2_statement_of_information

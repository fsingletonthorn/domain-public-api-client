...
from ..models.listings_v1_listing_channel import ListingsV1ListingChannel
from ..models.listings_v1_listing_objective import ListingsV1ListingObjective
from ..models.listings_v1_listing_property_types_item import ListingsV1ListingPropertyTypesItem
from ..models.listings_v1_listing_sale_mode import ListingsV1ListingSaleMode
from ..models.listings_v1_listing_status import ListingsV1ListingStatus
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.listings_v1_address_parts import ListingsV1AddressParts
    from ..models.listings_v1_advertiser_identifiers import ListingsV1AdvertiserIdentifiers
    from ..models.listings_v1_australian_property_monitors_identifiers import (
        ListingsV1AustralianPropertyMonitorsIdentifiers,
    )
    from ..models.listings_v1_geo_location import ListingsV1GeoLocation
    from ..models.listings_v1_listing_media import ListingsV1ListingMedia
    from ..models.listings_v1_price_details import ListingsV1PriceDetails
    from ..models.listings_v1_property_inspections import ListingsV1PropertyInspections
    from ..models.listings_v1_provider_details import ListingsV1ProviderDetails
    from ..models.listings_v1_rental_details import ListingsV1RentalDetails
    from ..models.listings_v1_sale_details import ListingsV1SaleDetails
    from ..models.listings_v1_statement_of_information import ListingsV1StatementOfInformation


T = TypeVar("T", bound="ListingsV1Listing")


@_attrs_define
class ListingsV1Listing:
    r"""Represents a Property Listing

    Attributes:
        id (int): The identifier which uniquely identifies the listing.
        advertiser_identifiers (ListingsV1AdvertiserIdentifiers): Encapsulates the listing's advertiser identifiers
        property_types (List[ListingsV1ListingPropertyTypesItem]): Types of the property
        objective (Union[Unset, ListingsV1ListingObjective]): Gets or Sets Objective
        status (Union[Unset, ListingsV1ListingStatus]): Gets or Sets Status
        sale_mode (Union[Unset, ListingsV1ListingSaleMode]): Gets or Sets SaleMode
        channel (Union[Unset, ListingsV1ListingChannel]): Gets or Sets Channel
        address_parts (Union[Unset, ListingsV1AddressParts]): Encapsulates the parts that make up an Address
        apm_identifiers (Union[Unset, ListingsV1AustralianPropertyMonitorsIdentifiers]): APM Identifiers
        ...
        geo_location (Union[Unset, ListingsV1GeoLocation]): Encapsulates the details of a geo location, long/lat
        headline (Union[None, Unset, str]): The short description of the property provided by the advertiser.
        inspection_details (Union[Unset, ListingsV1PropertyInspections]): Property Inspection(s) details
        ...
        media (Union[List['ListingsV1ListingMedia'], None, Unset]): The media associated with the property provided by
            the advertiser
        price_details (Union[Unset, ListingsV1PriceDetails]): Encapsulates a listing's price information
        ...
        provider_details (Union[Unset, ListingsV1ProviderDetails]): Information for the listing provider. e.g.
            bulkuploader information
        rental_details (Union[Unset, ListingsV1RentalDetails]): The rental detail's of the listing in case of it being
            for rent or leased
        sale_details (Union[Unset, ListingsV1SaleDetails]): The sale detail's of the listing in case of it being for
            sale or sold
        ...
        statement_of_information (Union[Unset, ListingsV1StatementOfInformation]): Statement of Information  Regarding
            sale listing
    ...
    id: int
    advertiser_identifiers: "ListingsV1AdvertiserIdentifiers"
    property_types: List[ListingsV1ListingPropertyTypesItem]
    objective: Union[Unset, ListingsV1ListingObjective] = UNSET
    status: Union[Unset, ListingsV1ListingStatus] = UNSET
    sale_mode: Union[Unset, ListingsV1ListingSaleMode] = UNSET
    channel: Union[Unset, ListingsV1ListingChannel] = UNSET
    address_parts: Union[Unset, "ListingsV1AddressParts"] = UNSET
    apm_identifiers: Union[Unset, "ListingsV1AustralianPropertyMonitorsIdentifiers"] = UNSET
    ...
    geo_location: Union[Unset, "ListingsV1GeoLocation"] = UNSET
    headline: Union[None, Unset, str] = UNSET
    inspection_details: Union[Unset, "ListingsV1PropertyInspections"] = UNSET
    ...
    media: Union[List["ListingsV1ListingMedia"], None, Unset] = UNSET
    price_details: Union[Unset, "ListingsV1PriceDetails"] = UNSET
    property_id: Union[None, Unset, str] = UNSET
    provider_details: Union[Unset, "ListingsV1ProviderDetails"] = UNSET
    rental_details: Union[Unset, "ListingsV1RentalDetails"] = UNSET
    sale_details: Union[Unset, "ListingsV1SaleDetails"] = UNSET
    ...
    statement_of_information: Union[Unset, "ListingsV1StatementOfInformation"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        advertiser_identifiers = ListingsV1AdvertiserIdentifiers.from_dict(d.pop("advertiserIdentifiers"))

        property_types = []
        _property_types = d.pop("propertyTypes")
        for property_types_item_data in _property_types:
            property_types_item = ListingsV1ListingPropertyTypesItem(property_types_item_data)

            property_types.append(property_types_item)

        _objective = d.pop("objective", UNSET)
        objective: Union[Unset, ListingsV1ListingObjective]
        if isinstance(_objective, Unset):
            objective = UNSET
        else:
            objective = ListingsV1ListingObjective(_objective)

        _status = d.pop("status", UNSET)
        status: Union[Unset, ListingsV1ListingStatus]
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = ListingsV1ListingStatus(_status)

        _sale_mode = d.pop("saleMode", UNSET)
        sale_mode: Union[Unset, ListingsV1ListingSaleMode]
        if isinstance(_sale_mode, Unset):
            sale_mode = UNSET
        else:
            sale_mode = ListingsV1ListingSaleMode(_sale_mode)

        _channel = d.pop("channel", UNSET)
        channel: Union[Unset, ListingsV1ListingChannel]
        if isinstance(_channel, Unset):
            channel = UNSET
        else:
            channel = ListingsV1ListingChannel(_channel)

        _address_parts = d.pop("addressParts", UNSET)
        address_parts: Union[Unset, ListingsV1AddressParts]
        if isinstance(_address_parts, Unset):
            address_parts = UNSET
        else:
            address_parts = ListingsV1AddressParts.from_dict(_address_parts)

        _apm_identifiers = d.pop("apmIdentifiers", UNSET)
        apm_identifiers: Union[Unset, ListingsV1AustralianPropertyMonitorsIdentifiers]
        if isinstance(_apm_identifiers, Unset):
            apm_identifiers = UNSET
        else:
            apm_identifiers = ListingsV1AustralianPropertyMonitorsIdentifiers.from_dict(_apm_identifiers)
        ...
        geo_location: Union[Unset, ListingsV1GeoLocation]
        if isinstance(_geo_location, Unset):
            geo_location = UNSET
        else:
            geo_location = ListingsV1GeoLocation.from_dict(_geo_location)
        ...
        inspection_details: Union[Unset, ListingsV1PropertyInspections]
        if isinstance(_inspection_details, Unset):
            inspection_details = UNSET
        else:
            inspection_details = ListingsV1PropertyInspections.from_dict(_inspection_details)
        ...
        def _parse_media(data: object) -> Union[List["ListingsV1ListingMedia"], None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for media_type_0_item_data in _media_type_0:
                    media_type_0_item = ListingsV1ListingMedia.from_dict(media_type_0_item_data)
                ...
                pass
            return cast(Union[List["ListingsV1ListingMedia"], None, Unset], data)

        media = _parse_media(d.pop("media", UNSET))

        _price_details = d.pop("priceDetails", UNSET)
        price_details: Union[Unset, ListingsV1PriceDetails]
        if isinstance(_price_details, Unset):
            price_details = UNSET
        else:
            price_details = ListingsV1PriceDetails.from_dict(_price_details)
        ...
        provider_details: Union[Unset, ListingsV1ProviderDetails]
        if isinstance(_provider_details, Unset):
            provider_details = UNSET
        else:
            provider_details = ListingsV1ProviderDetails.from_dict(_provider_details)

        _rental_details = d.pop("rentalDetails", UNSET)
        rental_details: Union[Unset, ListingsV1RentalDetails]
        if isinstance(_rental_details, Unset):
            rental_details = UNSET
        else:
            rental_details = ListingsV1RentalDetails.from_dict(_rental_details)

        _sale_details = d.pop("saleDetails", UNSET)
        sale_details: Union[Unset, ListingsV1SaleDetails]
        if isinstance(_sale_details, Unset):
            sale_details = UNSET
        else:
            sale_details = ListingsV1SaleDetails.from_dict(_sale_details)
        ...
        statement_of_information: Union[Unset, ListingsV1StatementOfInformation]
        if isinstance(_statement_of_information, Unset):
            statement_of_information = UNSET
        else:
            statement_of_information = ListingsV1StatementOfInformation.from_dict(_statement_of_information)

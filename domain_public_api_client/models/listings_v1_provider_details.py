...
T = TypeVar("T", bound="ListingsV1ProviderDetails")


@_attrs_define
class ListingsV1ProviderDetails:
    """Information for the listing provider. e.g. bulkuploader information

    Attributes:
        provider_system (Union[None, Unset, str]): Feed provider ID
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        listings_v1_provider_details = cls(
            provider_system=provider_system,
            provider_ad_id=provider_ad_id,
        )

        return listings_v1_provider_details

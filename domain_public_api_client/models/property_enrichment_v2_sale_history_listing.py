...
T = TypeVar("T", bound="PropertyEnrichmentV2SaleHistoryListing")


@_attrs_define
class PropertyEnrichmentV2SaleHistoryListing:
    """
    Attributes:
        id (Union[Unset, str]):
        ...
        sale_type (Union[None, Unset, str]): Sale type ['Auction', 'Private Treaty']
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        property_enrichment_v2_sale_history_listing = cls(
            id=id,
        ...
        property_enrichment_v2_sale_history_listing.additional_properties = d
        return property_enrichment_v2_sale_history_listing

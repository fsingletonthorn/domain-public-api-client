...
if TYPE_CHECKING:
    from ..models.listings_v2_inspection import ListingsV2Inspection


T = TypeVar("T", bound="ListingsV2PropertyInspections")


@_attrs_define
class ListingsV2PropertyInspections:
    """Property Inspection(s) details

    Attributes:
        inspections (Union[List['ListingsV2Inspection'], None, Unset]): Inspection details for the property. e.g.
            opening and closing times
        past_inspections (Union[List['ListingsV2Inspection'], None, Unset]): Inspection details for the property. e.g.
            opening and closing times
        is_by_appointment_only (Union[None, Unset, bool]): True or False indicating whether the inspection is by
            appointment only
    """

    inspections: Union[List["ListingsV2Inspection"], None, Unset] = UNSET
    past_inspections: Union[List["ListingsV2Inspection"], None, Unset] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_inspections(data: object) -> Union[List["ListingsV2Inspection"], None, Unset]:
            if data is None:
                return data
            ...
            try:
                ...
                for inspections_type_0_item_data in _inspections_type_0:
                    inspections_type_0_item = ListingsV2Inspection.from_dict(inspections_type_0_item_data)
                ...
                pass
            return cast(Union[List["ListingsV2Inspection"], None, Unset], data)

        inspections = _parse_inspections(d.pop("inspections", UNSET))

        def _parse_past_inspections(data: object) -> Union[List["ListingsV2Inspection"], None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for past_inspections_type_0_item_data in _past_inspections_type_0:
                    past_inspections_type_0_item = ListingsV2Inspection.from_dict(past_inspections_type_0_item_data)
